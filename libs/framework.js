...
class Animation {
  ...
  start() {
    this.running = true;
    console.log("node matrix: " + this.transformNode.matrix)
    console.log("previousSegmetMatrix: " + this.previousSegmentMatrix);
    this.segments.map(seg123 => console.log(seg123));
  }

  update(deltaTimeInMilliseconds) {
    console.log(this.currentIndex + ". segment: " + animation.currentSegment.matrix);
    if (this.running) {
